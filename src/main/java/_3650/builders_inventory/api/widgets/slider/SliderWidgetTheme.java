...
public class SliderWidgetTheme {
	...
	public final ResourceLocation spriteBackground;
	public final ResourceLocation spriteBackgroundHighlighted;
	public final ResourceLocation spriteBar;
	public final ResourceLocation spriteBarHighlighted;
	...
	private SliderWidgetTheme(
			ResourceLocation spriteBackground,
			ResourceLocation spriteBackgroundHighlighted,
			ResourceLocation spriteBar,
			ResourceLocation spriteBarHighlighted,
			int barHeight,
		...
		this.spriteBackgroundHighlighted = spriteBackgroundHighlighted;
		this.spriteBar = spriteBar;
		this.spriteBarHighlighted = spriteBarHighlighted;
