...
public class StepSliderWidget extends AbstractWidget {
	...
	protected void renderWidget(GuiGraphics gui, int mouseXi, int mouseYi, float partialTick) {
		...
		gui.blitSprite(RenderType::guiTextured, this.isFocused() && !this.focusDragging ? theme.spriteBackgroundHighlighted : theme.spriteBackground, this.getX(), this.getY(), this.width, this.height);
