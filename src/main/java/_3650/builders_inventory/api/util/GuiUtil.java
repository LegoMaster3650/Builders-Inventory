...
public class GuiUtil {
	...
	public static void blitScreenBackground(GuiGraphicsExtractor gui, Identifier atlasId, int x, int y, int width, int height) {
		gui.blit(RenderPipelines.GUI_TEXTURED, atlasId, x, y, 0, 0, width, height, 256, 256);
	}
	
	public static void renderSlotHighlightBack(GuiGraphicsExtractor gui, int x, int y) {
		gui.blitSprite(RenderPipelines.GUI_TEXTURED, SPRITE_SLOT_HIGHLIGHT_BACK, x - 4, y - 4, 24, 24);
	}
	
	public static void renderSlotHighlightFront(GuiGraphicsExtractor gui, int x, int y) {
