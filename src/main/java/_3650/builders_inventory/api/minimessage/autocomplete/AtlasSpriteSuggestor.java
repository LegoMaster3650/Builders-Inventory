...
public class AtlasSpriteSuggestor implements Suggestor {
	...
	private Object2ObjectOpenHashMap<ResourceLocation, AutocompleteArg> cache = new Object2ObjectOpenHashMap<>();
	...
	public Optional<AutocompleteArg> getAtlasArg(String id) {
		...
		try {
			atlasId = ResourceLocation.withDefaultNamespace(id);
	...
	public Optional<AutocompleteArg> getAtlasArg(ResourceLocation atlasId) {
		...
		Map<ResourceLocation, TextureAtlasSprite> texturesByName = ((TextureAtlasAccessor)atlas).getTexturesByName();
